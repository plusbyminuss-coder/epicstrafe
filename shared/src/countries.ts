...
export function formatCountryCode(code: string) {
    const countryValue = CODE_TO_COUNTRY.get(code ?? "");
    return countryValue?.label ?? "";
}
...
export const CODE_TO_COUNTRY = new Map<string, CountryType>();
for (const country of COUNTRIES) {
    CODE_TO_COUNTRY.set(country.code, country);
}