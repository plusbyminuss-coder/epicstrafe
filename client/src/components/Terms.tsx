...
function Terms() {
    ...
    <Box display="flex" justifyContent="center">
        <Box maxWidth="1024px">
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Strafes.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Strafes, accessible from <Link href="https://strafes.fiveman1.net/">https://strafes.fiveman1.net/</Link></p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: carterpenterman@gmail.com</li>
            </ul>
        </Box>
    </Box>
    )
